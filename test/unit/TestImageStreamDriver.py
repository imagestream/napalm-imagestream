...
class TestConfigImageStreamDriver(unittest.TestCase, TestConfigNetworkDriver):
    ...
    def setUpClass(cls):
        ...
        username = 'vagrant'
        password = 'vagrant'
        cls.vendor = 'imagestream'

        optional_args = {'port': 12443, }
        cls.device = imagestream.ImageStreamDriver(hostname, username, password, timeout=60,
